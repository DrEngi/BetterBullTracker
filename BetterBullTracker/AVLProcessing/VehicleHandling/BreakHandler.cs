...
namespace BetterBullTracker.AVLProcessing.VehicleHandling
{
    public static class BreakHandler
    {
         ...
         * 3. on routes a,c,d,e modified:
         *    a. when a vehicle is stopped for excessive time on the east side of the marshall center
         *    b. when a vehicle is stopped for excessive time on the northeast side of the library (leroy collins)
         * 4. on route b:
         *    a. when a vehicle is stopped for excessive time on the east side of the marshall center
         ...
         * (in my own experience, drivers usually stop at the proper stop locations to recover headway, but the NEC might be a problem in particular)
        **/
    }
}
